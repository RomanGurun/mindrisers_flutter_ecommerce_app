...
return Column(
  children: [
    Hero(
      ...
      child:Image.asset(widget.eCommerceApp.image,
...
children: [
  Row(
    ...
    children: [
      ...
      Text(" (${widget.eCommerceApp.review})",
...
//             ),
  ...
  Row(
    children: [
      Text("\$ ${widget.eCommerceApp.price.toString()}.00",
        style: TextStyle(fontWeight:FontWeight.w600,
            fontSize: 18,
            color: Colors.pink,
            height: 1.5
      ...
      if(widget.eCommerceApp.isCheck == true)
        Text("\$ ${widget.eCommerceApp.price +255}.00",
  ...
  SizedBox(height: 15,),
  Text(
      "$widget.myDescription1 ${widget.eCommerceApp.name}",
  style: TextStyle(
    fontSize: 16,
